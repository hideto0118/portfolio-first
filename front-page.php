      ...
      <section id="about" class="about">
        ...
        <div id="about__description" class="about__description">
          ...
          <ul class="about__description__sns">
            ...
            <li><a href="https://www.linkedin.com/in/hideto-yasunori-57a440aa?trk=hp-identity-name" target="_blank"><svg class="icon__sns icon__sns--linkedin"><use xlink:href="#logo-linkedin"></use></svg></a></li>
        ...
        <div class="skill_range_outer">
          ...
          <div id="skill02" class="skill_range_inner">
            ...
            <ul>
              ...
              <li>Woocommerce<span class="seventyFive"></span></li>
              <li>PHP<span class="fifty"></span></li>
            </ul>
          </div>
